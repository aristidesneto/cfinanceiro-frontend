  ...
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Incomes' ? activeClass : inactiveClass]"
          to="/incomes"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Receitas</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Expenses' ? activeClass : inactiveClass]"
          to="/expenses"
        >
          <svg
            class="w-5 h-5"
        ...
        >
          ...
          <span class="mx-4">Categorias</span>
        </router-link> -->
      </nav>
    </div>
  </div>
