      ...
      <div class="flex flex-wrap -mx-6">
        <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
          ...
          >
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-700">R$ 2.000,00</h4>
              <div class="text-gray-500">Despesas do mês (UP 1,5%)</div>
            </div>
          </div>
        </div>
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
          ...
          >
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-700">R$ 3.000,00</h4>
              <div class="text-gray-500">Receita do mês (DOWN 0,5%)</div>
            </div>
          </div>
        </div>
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
          ...
          >
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-700">R$ 1.000,00</h4>
              <div class="text-gray-500">Saldo do mês</div>
            </div>
          </div>
        </div>
      </div>
